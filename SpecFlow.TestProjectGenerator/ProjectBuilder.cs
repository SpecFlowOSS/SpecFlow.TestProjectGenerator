    ...
    public class ProjectBuilder
    {
        ...
        private void EnsureProjectExists()
        {
            ...
            if (ProjectType == ProjectType.Library)
            {
                ...
                {
                    _project.AddNuGetPackage("Cucumber.Messages", "4.0.0", new NuGetPackageAssembly("Cucumber.Messages, Version=4.0.0, Culture=neutral, PublicKeyToken=b10c5988214f940c", "net45\\Cucumber.Messages.dll"));
