    ...
    public class ProjectBuilder
    {
        ...
        private void EnsureProjectExists()
        {
            ...
            if (ProjectType == ProjectType.Library)
            {
                ...
                _project.AddNuGetPackage("Cucumber.CucumberExpressions", "15.1.1", new NuGetPackageAssembly("CucumberExpressions, Version=15.1.1.0, Culture=neutral, PublicKeyToken=86496cfa5b4a5851", "netstandard2.0\\CucumberExpressions.dll"));
